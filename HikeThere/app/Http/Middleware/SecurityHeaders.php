...
class SecurityHeaders
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $csp = "default-src 'self'; " .
               "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://maps.googleapis.com https://cdn.jsdelivr.net https://code.iconify.design https://unpkg.com https://code.jquery.com https://cdnjs.cloudflare.com https://static.cloudflareinsights.com; " .
