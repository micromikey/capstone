                        ...
                        <div class="bg-white overflow-hidden shadow-xl rounded-2xl border border-gray-200 hover:shadow-2xl transition-all duration-300 hover:scale-105 flex flex-col">
                            ...
                            <div class="p-6 flex-grow flex flex-col">
                                ...
                                <div class="space-y-2 mt-auto">
                                    ...
                                    <a href="{{ route('itinerary.pdf', $itinerary) }}" target="_blank" class="block w-full text-center bg-gray-600 hover:bg-gray-700 text-white py-2.5 px-4 rounded-lg font-semibold text-sm transition-all duration-200 transform hover:scale-105 shadow-md">
                                        <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
