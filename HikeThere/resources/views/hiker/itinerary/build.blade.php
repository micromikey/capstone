          ...
          <div class="rounded-2xl bg-white/85 backdrop-blur-xl ring-1 ring-black/5 p-5 md:p-6">
                  ...
                  <div>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                      <label class="flex items-center gap-2">
                        ...
                        <input type="time" name="time" class="rounded-md border border-gray-300 px-2 py-1.5 text-sm ring-1 ring-gray-200 focus:ring-2 focus:ring-emerald-200 w-28 transition" />
                      </label>
                      <label class="flex items-center gap-2">
                        <span class="text-xs font-medium text-gray-600">Date</span>
                        <input type="date" name="date" class="rounded-md border border-gray-300 px-2 py-1.5 text-sm ring-1 ring-gray-200 focus:ring-2 focus:ring-emerald-200 w-40 transition" />
                      </label>
                    </div>
                  </div>
                  ...
                  <div class="rounded-xl border border-gray-100 bg-gray-50/70 p-3">
                    <div class="grid gap-3">
                      <div>
                        ...
                        <p class="text-sm text-gray-800">123 Mabini Street, San Isidro, Quezon City</p>
                      </div>
                      <div class="border-t border-dashed pt-2">
                        <p class="text-[11px] font-semibold uppercase tracking-wide text-gray-500">Destination</p>
                        <p class="text-sm text-gray-800">Mt. Pulag National Park, Kabayan, Benguet</p>
                      </div>
                    </div>
            ...
            <div class="mt-5 rounded-xl border border-white/70 bg-white/85 p-4 ring-1 ring-black/5 backdrop-blur">
              <div class="mb-3">
                ...
                <p class="mt-0.5 text-xs text-gray-500">Based on your previous hiking preferences.</p>
              </div>
                ...
                <div class="relative w-full sm:w-72">
                  <div class="rounded-md bg-gradient-to-r from-emerald-300/40 to-cyan-300/40 p-[1px]">
                    <select name="trail" class="appearance-none bg-none shadow-none pr-8 w-full rounded-md bg-white px-3 py-2 text-sm ring-1 ring-gray-300 focus:ring-2 focus:ring-emerald-200">
                      <option selected disabled>Select option</option>
                      <option value="Ambangeg Trail">Ambangeg Trail</option>
                      <option value="Akiki Trail">Akiki Trail</option>
                      <option value="Tawangan Trail">Tawangan Trail</option>
                    </select>
                  </div>
