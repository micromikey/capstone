                                ...
                                <div class="flex gap-6">
                                    <label class="flex items-center space-x-2">
                                        <input type="radio" name="{{ $q['name'] }}" value="yes"
                                            class="appearance-none w-6 h-6 rounded-full border-2 border-gray-400 checked:bg-yellow-500 checked:border-yellow-500 focus:outline-none transition duration-150"
