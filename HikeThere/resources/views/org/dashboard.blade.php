                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200">
                            ...
                            <div class="text-right">
                                <p class="text-2xl font-bold text-green-600">{{ $trailsWithEmergencyInfo }}</p>
                                <p class="text-xs text-green-700">{{ Str::plural('Trail', $trailsWithEmergencyInfo) }}</p>
                            </div>
                        </div>

                        <!-- Needs Attention -->
                        @if($trailsNeedingEmergencyInfo > 0)
                        ...
                        <!-- Action Button -->
                        <div class="pt-2">
                            <a href="{{ route('org.trails.index') }}" class="block w-full text-center px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white rounded-lg font-semibold shadow-lg transition flex items-center justify-center gap-2">
