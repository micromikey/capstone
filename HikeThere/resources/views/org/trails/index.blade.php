        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if($trails->count() > 0)
                ...
                <div class="mb-6 flex justify-between items-center">
                    <div class="flex gap-2">
                        <button onclick="switchView('card')" id="card-view-btn" class="px-4 py-2 rounded-lg font-semibold transition-all bg-[#336d66] text-white">
                            <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                            </svg>
                            3D Card View
                        </button>
                        <button onclick="switchView('table')" id="table-view-btn" class="px-4 py-2 rounded-lg font-semibold transition-all bg-gray-200 text-gray-700 hover:bg-gray-300">
                            <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {{-- 3D Card View --}}
                <div id="card-view" class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                {{-- Table View --}}
                <div id="table-view" class="hidden bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6">
