        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <form class="flex items-center max-w-2xl w-full relative" action="{{ route('trails.search') }}" method="GET">   
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="header-search-input" name="q" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full ps-10 p-3" placeholder="Search trails, organizations, locations..." value="{{ request('q') }}" autocomplete="off" />
