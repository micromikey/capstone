...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('org.community.index') }}" :active="request()->routeIs('org.community.*')">
                        {{ __('Posts') }}
                    </x-nav-link>
                        ...
                        <div class="relative">
                            ...
                            <div x-show="open"
                                ...
                                <div class="rounded-md ring-1 ring-black ring-opacity-5 py-1 bg-white">
                                    ...
                                    <a href="{{ route('community.index', ['tab' => 'posts']) }}" class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">
                                        <div class="flex items-center">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('org.community.index') }}" :active="request()->routeIs('org.community.*')">
                {{ __('Posts') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link href="{{ route('community.index', ['tab' => 'posts']) }}" :active="request()->routeIs('community')">
                <div class="flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
                    </svg>
            ...
            <x-responsive-nav-link href="{{ route('community.index', ['tab' => 'events']) }}" :active="request()->routeIs('community')">
                <div class="flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
            ...
            <x-responsive-nav-link href="{{ route('hiker.incidents.index') }}" :active="request()->routeIs('community')">
                <div class="flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
