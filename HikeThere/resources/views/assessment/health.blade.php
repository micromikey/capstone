        ...
        <div class="flex justify-between items-center">
            <div class="space-y-2">
                ...
                <h1 class="text-gray-600 text-lg font-medium flex items-center gap-2">
                    <span class="inline-flex items-center justify-center w-6 h-6 bg-blue-100 text-blue-800 text-sm font-bold rounded-full">3</span>
                    Health Screen
                </h1>
            </div>
        </div>
        ...
        <form action="{{ route('assessment.health.store') }}" method="POST" class="space-y-4">
            ...
            <div class="bg-gradient-to-r from-red-50 to-orange-50 rounded-xl p-6 border border-red-100">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Health & Medical Assessment</h3>
                        <p class="text-red-700 text-sm mb-4">Help us understand your health status for a safe hiking experience</p>
                        ...
                        <div class="bg-white/60 rounded-lg p-4 border border-red-100">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="text-xs text-gray-700 leading-relaxed">
                                    <p class="font-medium text-gray-800 mb-1">Medical Safety Assessment</p>
                                    <p>Your honest responses help us ensure appropriate safety measures and emergency preparedness. All medical information is kept confidential and used solely for safety planning purposes.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-y-3">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div class="flex-1">
                                <h4 class="font-semibold text-gray-800 text-base mb-2">Health Conditions</h4>
                                <p class="text-sm text-gray-600 mb-4">Please select any of the following health conditions that apply to you:</p>
                            </div>
                        </div>
                        ...
                        <div class="pl-11">
                            ...
                            <div class="mt-4">
                                ...
                                <input type="text" name="health_other" id="health_other" class="w-full border-2 border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-gray-400">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="chest_pain_activity" type="frequency" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="breath_uphill" type="frequency" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="dizziness_exercise" type="frequency" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="heart_palpitations" type="frequency" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="wheezing_exercise" type="frequency" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="persistent_cough" type="frequency" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="joint_pain_terrain" type="frequency" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="muscle_fatigue" type="frequency" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="balance_problems" type="frequency" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="heat_exhaustion_history" type="frequency" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="medication_effects" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        <div class="flex items-start gap-4 mb-4">
                            <div class="p-2 bg-fuchsia-50 rounded-lg">
                                <svg class="w-5 h-5 text-fuchsia-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                            </div>
                            <div class="flex-1">
                                <label for="current_medications" class="block font-semibold text-gray-800 text-base mb-2">
                        ...
                        <div class="pl-11">
                            <textarea name="current_medications" id="current_medications" rows="3" 
                                      class="w-full border-2 border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-fuchsia-500 focus:border-fuchsia-500 transition-all duration-200 hover:border-gray-400"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div class="flex-1">
                                <label for="medical_concerns" class="block font-semibold text-gray-800 text-base mb-2">
                        ...
                        <div class="pl-11">
                            <textarea name="medical_concerns" id="medical_concerns" rows="3" 
                                      class="w-full border-2 border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-neutral-500 focus:border-neutral-500 transition-all duration-200 hover:border-gray-400"
