<x-app-layout>
        ...
        <div class="flex justify-between items-center">
            <div class="space-y-2">
                ...
                <h1 class="text-gray-600 text-lg font-medium flex items-center gap-2">
                    <span class="inline-flex items-center justify-center w-6 h-6 bg-green-100 text-green-800 text-sm font-bold rounded-full">6</span>
                    Environment
                </h1>
            </div>
        </div>
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        <form action="{{ route('assessment.environment.store') }}" method="POST" class="space-y-4">
            ...
            <!-- Header Card -->
            <div class="bg-gradient-to-r from-green-50 to-yellow-50 rounded-xl p-6 border border-green-100">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Environmental Care Assessment</h3>
                        <p class="text-green-700 text-sm mb-4">Protect nature and minimize your impact—responsible hiking keeps trails beautiful for everyone.</p>
                        <div class="bg-white/60 rounded-lg p-4 border border-green-100">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="text-xs text-gray-700 leading-relaxed">
                                    <p class="font-medium text-gray-800 mb-1">Leave No Trace Principles</p>
                                    <p>Following these principles helps preserve the environment and ensures a safe, enjoyable experience for all hikers.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-y-3">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-gray-700 mb-2">Leave No Trace Principles</h3>
                                <p class="text-sm text-gray-600 mb-4">Select all items that are part of the 7 Leave No Trace principles:</p>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3">
                                @foreach($principles as $i => $principle)
                                    <label class="inline-flex items-center text-sm">
                                        <input type="checkbox" name="principles[]" value="{{ $principle }}" class="mr-3 w-4 h-4 text-green-600 border-gray-300 rounded focus:ring-green-500">
                                        {{ $principle }}
                                    </label>
                                @endforeach
                            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                    <div class="p-4">
                        ...
                        <div class="pl-11">
                            <x-likert-scale name="{{ $q['name'] }}" type="frequency" />
                        </div>
                    </div>
                </div>
                @endforeach
                ...
                <div class="flex justify-between items-center gap-4 flex-wrap">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ route('assessment.emergency') }}"
                            ...
                            <span>Back: Emergency Screen</span>
                        </a>
                    </div>
                    <!-- Message -->
                    <div class="flex-1 text-center">
                        <p class="text-sm text-gray-600">
                            Complete your environment assessment to finish your pre-hike safety check.
                        </p>
                    </div>
